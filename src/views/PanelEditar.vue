...
let enviar=async ()=>
{
    ...
    formData.append('receta_id', route.params.id);
    try {
        let resp = await fetch(`${import.meta.env.VITE_API_URL}recetas-helpers/foto`, 
        {
            method: 'POST',
            body:formData,
            ...
            <div className="row h-100 align-items-center">
                <div className="col-12">
                    <div className="breadcumb-text text-center">
                        <h2>Editar foto receta: {{ datos?.nombre }}</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="section-heading">
                        <h3>Editar foto receta: {{ datos?.nombre }}</h3>
                    </div>
                </div>
            </div>
                        ...
                        <Form @submit="enviar()">
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <img :src="datos?.foto" style="width: 200px;" />
                                    <hr/>
                                </div>
                                <div class="col-12 col-lg-12">
